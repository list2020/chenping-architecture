...
import com.ping.chen.exception.GlobalException;
import com.ping.chen.model.ColumnEntity;
import com.ping.chen.model.TableEntity;
...
//		templates.add("vm/menu.sql.vm");
	...
	public static void generatorCode(Map<String, String> table,
		...
		map.put("resource", config.getString("resource"));
	...
	public static String getFileName(String template, String className, String packageName){
		...
		if(template.contains("Dao.xml.vm")){
			return "main" + File.separator + "resources" + File.separator + "config" + File.separator + "mapper" + File.separator + config.getString("resource") + File.separator + className + "Dao.xml";
		}

//		if(template.contains("list.html.vm")){
//			return "main" + File.separator + "resources" + File.separator + "views" + File.separator
//					+ config.getString("resource") + File.separator + className.toLowerCase() + ".html";
//		}
//
//		if(template.contains("list.js.vm")){
//			return "main" + File.separator + "resources" + File.separator + "static" + File.separator
//					   + config.getString("resource")  +  File.separator + "js" + File.separator + className.toLowerCase() + ".js";
//		}
//
